...
var _SlideView = __webpack_require__(26);
...
var ExampleApp = function ExampleApp(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "h1",
      null,
      "This is Example App of SlideView"
    ),
    _react2.default.createElement(
      _SlideView2.default,
...
var Container = document.getElementById("example-app");
_reactDom2.default.render(_react2.default.createElement(ExampleApp, null), Container);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var invariant=__webpack_require__(4);var React=__webpack_require__(1);var warning=__webpack_require__(8);var ExecutionEnvironment=__webpack_require__(9);var _assign=__webpack_require__(2);var emptyFunction=__webpack_require__(3);var checkPropTypes=__webpack_require__(6);var getActiveElement=__webpack_require__(10);var shallowEqual=__webpack_require__(11);var containsNode=__webpack_require__(12);var emptyObject=__webpack_require__(5);var hyphenateStyleName=__webpack_require__(13);var camelizeStyleName=__webpack_require__(24);// Relying on the `invariant()` implementation lets us
// have preserve the format and params in the www builds.
...
var SlideViewWrapper = _styledComponents2.default.div(_templateObject);

var SlideView = function (_Component) {
  _inherits(SlideView, _Component);

  function SlideView(props) {
    _classCallCheck(this, SlideView);

    var _this = _possibleConstructorReturn(this, (SlideView.__proto__ || Object.getPrototypeOf(SlideView)).call(this, props));
  ...
  _createClass(SlideView, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        ...
        if (_this2.props.auto) {
          _this2.sliderInterval = setInterval(function () {
            _this2.move("right");
          }, _this2.props.speed);
        }
      });
    ...
    value: function move(target) {
      ...
      this.setState({
        ...
        var width = _this3.getWidthChilds();
        _this3.state.elSlider.scroll({
          left: width * _this3.state.active,
          behavior: "smooth"
        });
      });
    }
    ...
    key: "setActive",
    value: function setActive(scrollTarget) {
      var childCount = this.state.elSlider.childElementCount;
    ...
    key: "getTotalChilds",
    value: function getTotalChilds() {
      return this.state.elSlider.childElementCount;
    }
  }, {
    key: "getWidthChilds",
    value: function getWidthChilds() {
      var width = this.state.elSlider.offsetWidth;
      return width;
    }
  }, {
    key: "render",
        ...
        this.state.elSlider && this.state.elSlider.childElementCount > 1 ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            function () {
                ...
                nav.push(_react2.default.createElement(
                  "li",
                  {
                    ...
                    onClick: function onClick() {
                      var oldActive = _this4.state.active;
                      _this4.setState({ active: _this4.state.active > n ? n + 1 : n - 1 }, function () {
                        // clearInterval(this.sliderInterval)
                        if (_this4.state.active > oldActive) _this4.move("right");else _this4.move("left");
                      });
                    }
                  },
              ...
              for (var n = 0; n < _this4.state.elSlider.childElementCount; n++) {
                _loop(n);
              }
...
var _stylis = __webpack_require__(29);

var _stylis2 = _interopRequireDefault(_stylis);

var _stylisRuleSheet = __webpack_require__(30);
...
var contextShape = (_contextShape = {}, _contextShape[CHANNEL] = _propTypes2.default.func, _contextShape[CHANNEL_NEXT] = CONTEXT_CHANNEL_SHAPE, _contextShape);
...
var modifiedContextShape = _extends({}, contextShape, (_babelHelpers$extends = {}, _babelHelpers$extends[CONTEXT_KEY] = _propTypes2.default.oneOfType([_propTypes2.default.instanceOf(StyleSheet), _propTypes2.default.instanceOf(ServerStyleSheet)]), _babelHelpers$extends));
